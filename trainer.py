...
class Trainer:
    def __init__(self, model, optimizer, criterion = loss_func, patience = 100, device = DEVICE):
    ...
    def train(self, train_loader, val_loader):
        ...
        # for epoch in range(self.num_epochs):
            ...
            self.scheduler.step(avg_train_loss) #=> scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.5, patience=3)
